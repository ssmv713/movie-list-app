...
class Search extends (0, _heropy.Component) {
    render() {
        ...
        this.el.innerHTML = `
     <input value="${(0, _movieDefault.default).state.searchText}"
...
exports.default = new (0, _heropy.Store)({
    ...
    name: "SIMMY / SoMang Shim",
    email: "sshim2014@gmail.com",
    hithub: "https://github.com/ssmv713",
    repository: "https://github.com/ssmv713/movie-list-app.git"
});

},{"../core/heropy":"57bZf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4fDiL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _heropy = require("../core/heropy");
...
},{"../core/heropy":"57bZf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["75sNA","gLLPy"], "gLLPy", "parcelRequire9f4a")
